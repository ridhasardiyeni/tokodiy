			...
			<table class="w3-table-all w3-card-4">
				...
				@foreach($historys as $history)
					<tr>
						...
						<td>
							<form action="{{route('history.destroy', $history->id_history)}}" method="post"> 
								<a class="btn btn-sm btn-success" class="fas fa-edit" href="history-detail?kode_pembayaran={{$history->kode_pembayaran}}">
									<i class="fa big-icon fas fa-eye"></i>
								</a>
